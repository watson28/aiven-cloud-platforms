...
class TestCloudPlatformsService(TestCase):
    ...
    def test_raise_exception_when_downstream_service_not_returns_200(self, mock_requests: MagicMock):
    ...
    def test_raise_exception_when_downstream_service_returns_invalid_response(self, mock_requests: MagicMock):
    ...
    def test_returns_only_platforms_with_correct_format(self, mock_requests: MagicMock):
